...
// Requête pour modifier le nom
    function updateNom($_POST['email'])
    {
        $bdd= new PDO( 'mysql:host=localhost;dbname=g8b;port=3308;charset=UTF8', 'root', '');
    ...
    function updatePrenom($_POST['email'])
    {
        $bdd= new PDO( 'mysql:host=localhost;dbname=g8b;port=3308;charset=UTF8', 'root', '');
    ...
    function updateMdp($_POST['email'])
    {
        $bdd= new PDO( 'mysql:host=localhost;dbname=g8b;port=3308;charset=UTF8', 'root', '');
    ...
    function updateDateInscrip($_POST['email'])
    {
        $bdd= new PDO( 'mysql:host=localhost;dbname=g8b;port=3308;charset=UTF8', 'root', '');
    ...
    function updateDateNaiss$_POST['email'])
    {
        $bdd= new PDO( 'mysql:host=localhost;dbname=g8b;port=3308;charset=UTF8', 'root', '');
